...
facets = {
    ...
    'rights': ('rights', 'terms'),
    'sourceResource.collection.title': ('sourceResource.collection.title.not_analyzed', 'terms'),
    ...
    'sourceResource.date.begin.month': ('sourceResource.date.begin',
                                        'date_histogram'),
    'sourceResource.date.begin.decade': ('sourceResource.date.begin',
                                         'date_histogram'),
    'sourceResource.date.begin.century': ('sourceResource.date.begin',
                                          'date_histogram'),
    ...
    'sourceResource.date.end.month': ('sourceResource.date.end',
                                      'date_histogram'),
    'sourceResource.date.end.decade': ('sourceResource.date.end',
                                       'date_histogram'),
    'sourceResource.date.end.century': ('sourceResource.date.end',
                                        'date_histogram'),
    ...
    'sourceResource.temporal.begin.month': ('sourceResource.temporal.begin',
                                            'date_histogram'),
    'sourceResource.temporal.begin.decade': ('sourceResource.temporal.begin',
                                             'date_histogram'),
    'sourceResource.temporal.begin.century': ('sourceResource.temporal.begin',
                                              'date_histogram'),
    ...
    'sourceResource.temporal.end.month': ('sourceResource.temporal.end',
                                          'date_histogram'),
    'sourceResource.temporal.end.decade': ('sourceResource.temporal.end',
                                           'date_histogram'),
    'sourceResource.temporal.end.century': ('sourceResource.temporal.end',
                                            'date_histogram'),
